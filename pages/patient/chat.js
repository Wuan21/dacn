                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{
                          ...
                          height: '48px',
                          borderRadius: '50%',
                          background: chat.doctor.doctorprofile?.profileImage ? 'transparent' : 'linear-gradient(135deg, #2563eb 0%, #1e40af 100%)',
                          color: 'white',
                          display: 'flex',
                          alignItems: 'center',
                          ...
                          {chat.doctor.doctorprofile?.profileImage ? (
                            <img src={chat.doctor.doctorprofile.profileImage} alt={chat.doctor.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                          ) : (
                            chat.doctor.name.charAt(0).toUpperCase()
                          )}
                        </div>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: '13px', color: '#2563eb' }}>
                            {chat.doctor.doctorprofile?.specialty?.name || 'Bác sĩ'}
                          </div>
                          {chat.messages[0] && (
                            <div style={{
                              fontSize: '13px',
                ...
                <>
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      height: '48px',
                      borderRadius: '50%',
                      background: selectedChat.doctor.doctorprofile?.profileImage ? 'transparent' : 'rgba(255,255,255,0.2)',
                      color: 'white',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      ...
                      {selectedChat.doctor.doctorprofile?.profileImage ? (
                        <img src={selectedChat.doctor.doctorprofile.profileImage} alt={selectedChat.doctor.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                      ) : (
                        selectedChat.doctor.name.charAt(0).toUpperCase()
                      )}
                    </div>
                    <div>
                      ...
                      <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.9)' }}>
                        {selectedChat.doctor.doctorprofile?.specialty?.name || 'Bác sĩ'}
                      </div>
                    </div>
                  </div>
